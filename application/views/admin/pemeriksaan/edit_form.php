						...
						<form action="<?php base_url('admin/detail/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('id_detail') ? 'is-invalid':'' ?>"
								 type="text" name="id_detail" placeholder="Id Detail" value="<?php echo $detail->id_detail ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('jumlahbarang') ? 'is-invalid':'' ?>"
								 type="text" name="jumlahbarang" placeholder="Jumlah Barang" value="<?php echo $detail->jumlahbarang ?>" />
								<div class="invalid-feedback">
